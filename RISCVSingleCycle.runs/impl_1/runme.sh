...
HD_PWD='C:/Users/choth/OneDrive/Documents/xilinx/RISCV/RISCVSingleCycle/RISCVSingleCycle.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCV_topmodule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RISCV_topmodule.tcl -notrace
