...
HD_PWD='C:/Users/choth/Documents/RISCV/RISCVSingleCycle/RISCVSingleCycle.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RISCV_topmodule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RISCV_topmodule.tcl
